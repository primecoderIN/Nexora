...
To spin up the entire infrastructure (PostgreSQL, Redis, Mailpit, MinIO, Keycloak, and the API itself), simply run the startup script from the root directory:
...
| **PostgreSQL** | localhost:5432 | Database (use a GUI like DBeaver) |
